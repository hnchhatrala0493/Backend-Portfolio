                ...
                <ul class="nav nav-pills flex-column flex-sm-row mb-6 gap-2 gap-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="pages-profile-projects.html"><i
                                class="ti-sm ti ti-layout-grid me-1_5"></i>
                            Projects</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled mb-0 mt-3 pt-1">
                        <li class="d-flex flex-wrap mb-4">
                            <span class="fw-medium me-2">Backend
                                Developer</span><span>(126 Members)</span>
                        </li>
                        <li class="d-flex flex-wrap">
                            <span class="fw-medium me-2">React
                                Developer</span><span>(98 Members)</span>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="card card-action mb-6">
                <div class="card-header align-items-center">
                    <h5 class="card-action-title mb-0">
                        <i class="ti ti-chart-bar ti-lg text-body me-4"></i>Activity
                        Timeline
                    </h5>
                </div>
                    ...
                    <ul class="timeline mb-0">
                        <li class="timeline-item timeline-item-transparent">
                            ...
                            <div class="timeline-event">
                                ...
                                <p class="mb-2">Invoices have been paid to the
                                    company</p>
                        ...
                        <li class="timeline-item timeline-item-transparent">
                            ...
                            <div class="timeline-event">
                                ...
                                <p class="mb-2">Project meeting with john
                                    @10:15am</p>
                                <div class="d-flex justify-content-between flex-wrap gap-2 mb-2">
                                    <div class="d-flex flex-wrap align-items-center mb-50">
                                        ...
                                        <div>
                                            <p class="mb-0 small fw-medium">Lester
                                                McCarthy (Client)</p>
                        ...
                        <li class="timeline-item timeline-item-transparent">
                            ...
                            <div class="timeline-event">
                                <div class="timeline-header mb-3">
                                    <h6 class="mb-0">Create a new project for
                                        client</h6>
